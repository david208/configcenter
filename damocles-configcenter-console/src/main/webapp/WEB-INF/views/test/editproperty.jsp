...
function submitForm() {
	$("#searchForm").form('submit', {
		url : "${ctx}/editPropertys?system=${system}&version=${version}&env=${env}",
...
<body>
	...
	<form id="searchForm" method="post">
		<table>
			...
			<tr>			   
				<td>备注:</td>
				<td><input  type="text" name="memo" value="${propertyInfo.memo}" data-options="required:true"></input></td>				
			</tr>
			<tr>
			<td>tag:</td>
				<td><input  type="text" name="tag" value="${propertyInfo.tag}" data-options="required:true"></input></td>
			</tr>
			<tr>
			<tr>
				<td><a href="javascript:void(0)" style="vertical-align: middle;" class="easyui-linkbutton"
					onclick="submitForm()">修改</a></td>
